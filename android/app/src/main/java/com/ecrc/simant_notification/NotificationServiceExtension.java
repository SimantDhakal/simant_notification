package com.ecrc.simant_notification;
...
//            Spannable spannableTitle = new SpannableString(notification.getTitle());
            Spannable spannableTitle = new SpannableString("Source code title");
        ...
        Log.i("OneSignalExample", "Received Notification Data: " + notification.getTitle());
